    ...
    */
    ...
    public function verifyUser(Request $request){
        ...
        if($user != null){
            ...
            return redirect()->route('login')->with(session()->flash('alert-success', 'Your account is verified. Please log in!'));
        }
        return redirect()->route('login')->with(session()->flash('alert-success', 'Invalid registration code!'));
    }
